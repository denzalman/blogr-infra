...
resource "aws_instance" "jenkins" {
    ...
    inline = [
        ...
        #TODO: Remove an old ansible dir befor copy a new one
        "sudo cp -f -r -u $HOME/ansible /data/jenkins_home/",
        "sudo chmod 400 /data/jenkins_home/ansible/${var.key_name}.pem",
        "sudo docker run -u root -p 80:8080 -p 50000:50000 -d --restart unless-stopped -v /data/jenkins_home:/var/jenkins_home -v /var/run/docker.sock:/var/run/docker.sock -v $(which ansible):/usr/bin/ansible jenkinsci/blueocean",
